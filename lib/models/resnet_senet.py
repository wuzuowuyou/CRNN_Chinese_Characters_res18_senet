...
__all__ = ['ResNet', 'resnet18', 'resnet34', 'resnet50', 'resnet101',
           'resnet152', 'resnext50_32x4d', 'resnext101_32x8d', 'se_resnet18']
...
class ResNet(nn.Module):
    ...
    def forward(self, x):
        x = self.conv1(x) #[1,3,32,320] --> [1,64,16,160]
        x = self.bn1(x)  #[1,64,16,160]
        x = self.relu(x) #[1,64,16,160]
        x = self.maxpool(x) #[1,64,8,80]

        x = self.layer1(x) #[1,64,8,80]
        x = self.layer2(x) #[1,128,4,40]
        x = self.layer3(x) #[1,256,2,20]
        x = self.layer4(x) #[1,512,1,10]
